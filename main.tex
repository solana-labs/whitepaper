...
\begin{center}
  \begin{table}
  \caption[Table 3]{PoH Sequence With 2 Events\label{table:multievent}}
  \begin{tabular}{ | l | c | r |}
    Index & Hash & Operation \\ \hline
    1 & hash1 & sha256(\char`\"any random starting value\char`\") \\ \hline
    200 & hash200 & sha256(hash199) \\ \hline
...
In the sequence represented by Table\~\ref{table:multievent}, \texttt{photograph2} was created before \texttt{hash601}, and
