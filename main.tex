\title{Loom: High throughput fault tolerant Operating System (WIP, v0.8) }
...
The Proof of History sequence packet contains the current hash, counter, and the hash of all the new messages added to the stream up to this packet and the state signature after processing all the messages.
