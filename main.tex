...
\subsubsection{Collusion with the PoH generator}\label{collusion}
...
A malicious generator could inject data into the sequence prior to this hash to generate a specific hash.  This attack is discussed more in ~\ref{subsec:collusion}.
