...
\begin{figure}
  \begin{center}
    ...
    \caption[Fig 4]{Transaction flow throught the network.\label{fig_4}}
  \end{center}
  \end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \caption[Fig 5]{Input with a back reference.\label{fig_5}}
  \end{center}
  \end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \caption[Fig 6]{Executing user supplied BPF programs.\label{fig_6}}
  \end{center}
  \end{figure}
...
* Liskov, practical use of Clocks, http://www.dainf.cefetpr.br/~tacla/SDII/PracticalUseOfClocks.pdf
* Google Spanner TrueTime consistency, https://cloud.google.com/spanner/docs/true-time-external-consistency
* Solving Agreement with Ordering Oracles, http://www.inf.usi.ch/faculty/pedone/Paper/2002/2002EDCCb.pdf
* https://tendermint.com/static/docs/tendermint.pdf
* Filecoin, proof of replication, https://filecoin.io/proof-of-replication.pdf
