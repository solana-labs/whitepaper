...
過去に何が起きたか、それらがいつ頃に起きたかを、承認者から監視することがPoHにより可能になる。PoH生成者がメッセージストリームを流し出すごとに、承認者はそれらの状態に対して署名を付けて500ミリ秒以内に提出することが求められる。ネットワークの状況によっては、この時間はさらに短縮される。その承認内容自体がストリームへ挿入されるため、投票そのものを直接観測していなかったとしても、それがタイムアウト発生前に完了したかを後から確認することは誰にでも可能である。
